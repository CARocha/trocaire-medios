...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Escolaridad.conyugue'
        db.alter_column('familia_escolaridad', 'conyugue', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Escolaridad.conyugue'
        db.alter_column('familia_escolaridad', 'conyugue', self.gf('django.db.models.fields.IntegerField')(default=None))
