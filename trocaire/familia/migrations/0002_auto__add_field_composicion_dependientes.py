...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Composicion.dependientes'
        db.add_column('familia_composicion', 'dependientes', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Composicion.dependientes'
        db.delete_column('familia_composicion', 'dependientes')
