...
urlpatterns = patterns('trocaire.ingresos.views',
    ...
    url(r'rangos/(?P<maximo>\d+)/(?P<minimo>\d+)/(?P<separaciones>\d+)/$', 'generic_range', {'model':'totalingreso', 'field': 'total'}, name="ingresos_generic_range"),
    #ingreso ganado
    url(r'rangos/ganado/$', 'generic_range', {'model': 'ingresoganado', 'field': 'total'}, name="ingresos_ganado"),
    url(r'rangos/ganado/(?P<maximo>\d+)/(?P<minimo>\d+)/(?P<separaciones>\d+)/$', 'generic_range', {'model': 'ingresoganado', 'field': 'total'}, name="ingresos_ganado"),
    url(r'rangos/ganado/(?P<maximo>\d+)/(?P<minimo>\d+)/(?P<separaciones>\d+)/$', 'generic_range', {'model': 'ingresoganado', 'field': 'total'}, name="ingresos_ganado"),
    #fuentes ap
