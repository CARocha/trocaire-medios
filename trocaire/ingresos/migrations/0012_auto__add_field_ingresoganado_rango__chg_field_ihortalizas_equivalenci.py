...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IngresoGanado.rango'
        db.add_column('ingresos_ingresoganado', 'rango',
                      self.gf('django.db.models.fields.FloatField')(default=None),
                      keep_default=False)


        # Changing field 'IHortalizas.equivalencias'
        db.alter_column('ingresos_ihortalizas', 'equivalencias', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Deleting field 'IngresoGanado.rango'
        db.delete_column('ingresos_ingresoganado', 'rango')


        # Changing field 'IHortalizas.equivalencias'
        db.alter_column('ingresos_ihortalizas', 'equivalencias', self.gf('django.db.models.fields.FloatField')(default=None))
    ...
    models = {
        ...
        'ingresos.ingresoganado': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rango': ('django.db.models.fields.FloatField', [], {}),
            'total': ('django.db.models.fields.FloatField', [], {}),
