...
from ingresos.models import TotalIngreso, Encuesta

class Migration(DataMigration):

    def forwards(self, orm):
        '''Se crea un total ingreso por cada encuesta'''
        #borramos todo
        db.execute('delete from ingresos_totalingreso')
        for encuesta in Encuesta.objects.all():
            total_ingreso = TotalIngreso(encuesta=encuesta)
            total_ingreso.total = total_ingreso._get_total() 
            total_ingreso.save()
