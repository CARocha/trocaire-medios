...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'TotalIngreso', fields ['encuesta']
        db.create_unique('ingresos_totalingreso', ['encuesta_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'TotalIngreso', fields ['encuesta']
        db.delete_unique('ingresos_totalingreso', ['encuesta_id'])
