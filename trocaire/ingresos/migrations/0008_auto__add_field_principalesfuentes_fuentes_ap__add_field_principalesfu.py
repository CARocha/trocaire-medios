...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PrincipalesFuentes.fuentes_ap'
        db.add_column('ingresos_principalesfuentes', 'fuentes_ap', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PrincipalesFuentes.fuentes_no_ap'
        db.add_column('ingresos_principalesfuentes', 'fuentes_no_ap', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PrincipalesFuentes.fuentes_ap'
        db.delete_column('ingresos_principalesfuentes', 'fuentes_ap')

        # Deleting field 'PrincipalesFuentes.fuentes_no_ap'
        db.delete_column('ingresos_principalesfuentes', 'fuentes_no_ap')
