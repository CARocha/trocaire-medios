...
from ingresos.models import TotalIngreso

class Migration(DataMigration):

    def forwards(self, orm):
        '''Esta migracion se trata nada mas de calcular la cantidad y guardar en la BD
        el metodo save() se encarga de ello.'''
        for total_ingreso in TotalIngreso.objects.all(): 
            total_ingreso.save()
