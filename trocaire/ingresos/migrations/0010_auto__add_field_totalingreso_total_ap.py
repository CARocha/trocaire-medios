...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TotalIngreso.total_ap'
        db.add_column('ingresos_totalingreso', 'total_ap', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TotalIngreso.total_ap'
        db.delete_column('ingresos_totalingreso', 'total_ap')
