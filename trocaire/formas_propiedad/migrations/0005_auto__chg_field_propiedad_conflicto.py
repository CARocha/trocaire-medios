...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Propiedad.conflicto'
        db.alter_column('formas_propiedad_propiedad', 'conflicto', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Propiedad.conflicto'
        db.alter_column('formas_propiedad_propiedad', 'conflicto', self.gf('django.db.models.fields.IntegerField')(default=None))
