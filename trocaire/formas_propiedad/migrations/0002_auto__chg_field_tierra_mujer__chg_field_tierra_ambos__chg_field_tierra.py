...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tierra.mujer'
        db.alter_column('formas_propiedad_tierra', 'mujer', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Tierra.ambos'
        db.alter_column('formas_propiedad_tierra', 'ambos', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Tierra.hombre'
        db.alter_column('formas_propiedad_tierra', 'hombre', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'Tierra.mujer'
        db.alter_column('formas_propiedad_tierra', 'mujer', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Tierra.ambos'
        db.alter_column('formas_propiedad_tierra', 'ambos', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Tierra.hombre'
        db.alter_column('formas_propiedad_tierra', 'hombre', self.gf('django.db.models.fields.IntegerField')())
