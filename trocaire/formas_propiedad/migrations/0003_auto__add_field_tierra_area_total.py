...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tierra.area_total'
        db.add_column('formas_propiedad_tierra', 'area_total', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tierra.area_total'
        db.delete_column('formas_propiedad_tierra', 'area_total')
