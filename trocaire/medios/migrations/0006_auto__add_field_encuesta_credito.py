...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Encuesta.credito'
        db.add_column('medios_encuesta', 'credito', self.gf('django.db.models.fields.IntegerField')(default=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Encuesta.credito'
        db.delete_column('medios_encuesta', 'credito')
