...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Encuesta.sexo_jefe'
        db.add_column('medios_encuesta', 'sexo_jefe', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Encuesta.sexo_jefe'
        db.delete_column('medios_encuesta', 'sexo_jefe')
