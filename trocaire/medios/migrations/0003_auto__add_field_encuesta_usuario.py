...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Encuesta.usuario'
        db.add_column('medios_encuesta', 'usuario', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Encuesta.usuario'
        db.delete_column('medios_encuesta', 'usuario_id')
