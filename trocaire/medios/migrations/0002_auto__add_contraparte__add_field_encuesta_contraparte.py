...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Encuesta.contraparte'
        db.add_column('medios_encuesta', 'contraparte', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['medios.Contraparte'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Encuesta.contraparte'
        db.delete_column('medios_encuesta', 'contraparte_id')
