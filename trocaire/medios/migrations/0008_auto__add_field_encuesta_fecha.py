...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Encuesta.fecha'
        db.add_column('medios_encuesta', 'fecha', self.gf('django.db.models.fields.IntegerField')(default=2010), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Encuesta.fecha'
        db.delete_column('medios_encuesta', 'fecha')
    ...
    models = {
        ...
        'medios.encuesta': {
            ...
            'fecha': ('django.db.models.fields.IntegerField', [], {'default': '2010'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'municipio': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lugar.Municipio']"}),
