...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('medios_portada', (
        ...
        db.send_create_signal('medios', ['Portada'])

        # Adding field 'Encuesta.altura'
        db.add_column('medios_encuesta', 'altura', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Portada'
        db.delete_table('medios_portada')

        # Deleting field 'Encuesta.altura'
        db.delete_column('medios_encuesta', 'altura')
