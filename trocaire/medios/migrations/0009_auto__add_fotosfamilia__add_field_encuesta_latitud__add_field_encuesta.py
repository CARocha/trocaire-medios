...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FotosFamilia'
        db.create_table('medios_fotosfamilia', (
        ...
        db.send_create_signal('medios', ['FotosFamilia'])

        # Adding field 'Encuesta.latitud'
        db.add_column('medios_encuesta', 'latitud', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Encuesta.longitud'
        db.add_column('medios_encuesta', 'longitud', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Changing field 'Encuesta.comarca'
        db.alter_column('medios_encuesta', 'comarca_id', self.gf('smart_selects.db_fields.ChainedForeignKey')(to=orm['lugar.Comarca']))


    def backwards(self, orm):
        
        # Deleting model 'FotosFamilia'
        db.delete_table('medios_fotosfamilia')

        # Deleting field 'Encuesta.latitud'
        db.delete_column('medios_encuesta', 'latitud')

        # Deleting field 'Encuesta.longitud'
        db.delete_column('medios_encuesta', 'longitud')

        # Changing field 'Encuesta.comarca'
        db.alter_column('medios_encuesta', 'comarca_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lugar.Comarca']))
