...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FotosFamilia.encuesta'
        db.delete_column('medios_fotosfamilia', 'encuesta_id')

        # Adding field 'FotosFamilia.organizacion'
        db.add_column('medios_fotosfamilia', 'organizacion', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['medios.Contraparte']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'FotosFamilia.encuesta'
        db.add_column('medios_fotosfamilia', 'encuesta', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['medios.Encuesta']), keep_default=False)

        # Deleting field 'FotosFamilia.organizacion'
        db.delete_column('medios_fotosfamilia', 'organizacion_id')
    ...
    models = {
        ...
        'medios.fotosfamilia': {
            ...
            'organizacion': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['medios.Contraparte']"}),
