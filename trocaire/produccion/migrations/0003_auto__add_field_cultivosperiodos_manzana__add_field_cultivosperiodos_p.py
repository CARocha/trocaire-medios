...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CultivosPeriodos.manzana'
        db.add_column('produccion_cultivosperiodos', 'manzana', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'CultivosPeriodos.produccion'
        db.add_column('produccion_cultivosperiodos', 'produccion', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CultivosPeriodos.manzana'
        db.delete_column('produccion_cultivosperiodos', 'manzana')

        # Deleting field 'CultivosPeriodos.produccion'
        db.delete_column('produccion_cultivosperiodos', 'produccion')
