...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for objeto in orm.CultivosPeriodos.objects.all():
            objeto.manzana = sum(filter(None, [objeto.primera, objeto.postrera, objeto.apante]))
            objeto.produccion = sum(filter(None, [objeto.p_primera, objeto.p_postrera, objeto.p_apante]))
            objeto.save()
