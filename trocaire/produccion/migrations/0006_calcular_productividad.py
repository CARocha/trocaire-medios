...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for objeto in orm.CultivosPeriodos.objects.all():
            objeto.productividad = objeto.produccion / objeto.manzana if objeto.manzana != 0 else 0
            objeto.save()

        for objeto in orm.CultivosAnuales.objects.all():
            objeto.productividad = objeto.produccion / objeto.manzana if objeto.manzana != 0 else 0
            objeto.save()

        for objeto in orm.Hortalizas.objects.all():
            objeto.productividad = objeto.produccion / objeto.manzana if objeto.manzana != 0 else 0
            objeto.save()

        for objeto in orm.CultivosPermanentes.objects.all():
            objeto.productividad = objeto.produccion / objeto.manzana if objeto.manzana != 0 else 0
            objeto.save()
