...
urlpatterns = patterns('trocaire.produccion.views',
    ...
    url(r'rangos/productividad-maiz/$', 'generic_range', 
        {'dondetoy2':'maizproductividad','title': 'Productividad Maiz', 'subtitle': 'algo', 'eje': 'productividad', 'serie': 'productividad','model': 'cultivosperiodos', 'field': 'productividad', 'extra_params': {'cultivos__in': [1,2]}}, name="productividad_maiz"),
    ...
    url(r'rangos/productividad-frijol/$', 'generic_range', 
        {'dondetoy2':'frijolproductividad','title': 'Productividad Frijol', 'subtitle': 'algo', 'eje': 'productividad', 'serie': 'productividad','model': 'cultivosperiodos', 'field': 'productividad', 'extra_params': {'cultivos': 3}}, name="productividad_frijol"),
    ...
    url(r'rangos/productividad-cafe/$', 'generic_range', 
        {'dondetoy2':'cafeproductividad','title': 'Productividad Cafe', 'subtitle': 'algo', 'eje': 'productividad', 'serie': 'productividad','model': 'cultivospermanentes', 'field': 'productividad', 'extra_params': {'cultivos': 1}}, name="productividad_cafe"),
    ...
    url(r'rangos/productividad-cacao/$', 'generic_range', 
        {'dondetoy2':'cacaoproductividad','title': 'Productividad Cacao', 'subtitle': 'algo', 'eje': 'productividad', 'serie': 'productividad','model': 'cultivospermanentes', 'field': 'productividad', 'extra_params': {'cultivos': 2}}, name="productividad_cacao"),
